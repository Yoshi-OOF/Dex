...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Yoshi-OOF/Dex/main/CloneRef.lua", true))()

-- Dex Bypasses
loadstring(game:HttpGet("https://raw.githubusercontent.com/Yoshi-OOF/Dex/main/Bypasses.lua", true))()

-- Dex with CloneRef Support (made as global)
getgenv().Bypassed_Dex = game:GetObjects("rbxassetid://17408566785")[1]
